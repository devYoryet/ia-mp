...
def _layout(titulo: str, cuerpo: str) -> str:
    return (
        "<!doctype html><html lang=es><head><meta charset=utf-8>"
        "<meta name=viewport content='width=device-width,initial-scale=1'>"
        f"<title>{html.escape(titulo)} · IA Bot</title><style>{_CSS}</style></head><body>"
        "<header><b>IA Bot · Pharmatender</b><nav>"
        "<a href='/'>Resumen</a><a href='/comparacion'>Backtest</a>"
        "<a href='/revision'>Cola de revisión</a><a href='/reglas'>Reglas</a>"
        "</nav></header>"
